...
push!(Infected, [8900,9060,9193,8990,8705,8523,8230,8067,7603,7070,6835,6557,6288,6142,5844,5063,4441, 4014, 3796, 3694, 3411, 3087, 2786, 2669, 2509, 2401, 2363, 2208, 2043, 1961]...)
...
# May
# Dates =       [ 01.5, 02.5, 03.5, 04.5, 05.5, 06.5, 07.5, 08.5, 09.5, 10.5, 11.5, 12.5, 13.5, 14.5, 15.5, 16.6, 17.5, 18.5, 19.5, 20.5, 21.5, 22.5, 23.5, 24.5, 25.5, 26.5, 27.5, 28.5, 29.5, 30.5, 31.5]
push!(Infected, [ 1850, 1782, 1761, 1705, 1582, 1427, 1445, 1324, 1290, 1262, 1201, 1190, 1069, 1027, 1009, 1048, 1050, 1026, 1011,  838,  820,  796,  810,  800,  760,  732,  718,  674,  640,  497,  470]...)
push!(Recovered,[13092,13180,13228,13316,13462,13639,13698,13836,13928,13991,14061,14148,14304,14405,14471,14524,14563,14614,14678,14882,14951,15005,15035,15063,15138,15182,15228,15286,15347,15520,15593]...)
push!(Dead,     [  589,  596,  598,  600,  606,  608,  609,  614,  615,  618,  620,  623,  624,  626,  628,  629,  629,  629,  632,  633,  633,  635,  639,  640,  641,  643,  645,  668,  668,  668,  668]...)

# June
# Dates =       [ 01.6, 02.6, 03.6, 04.6, 05.6, 06.6, 07.6, 08.6]
push!(Infected, [  469,  461,  429,  418,  429,  437,  437,  457]...)
push!(Recovered,[15596,15629,15672,15717,15742,15789,15793,15839]...)
push!(Dead,     [  668,  669,  670,  670,  672,  672,  672,  672]...)
...
p_now, pred_I, pred_R, p1 = SINIR_prediction(Date(2020,2,25),Infected,Recovered,Dead,save=true,months=3,y_max=18000)
display(p1)

p_tot, = Logisitic_prediction(Infected, Recovered, Dead, save=true)
display(p_tot)

SINIR_animation(Date(2020,2,25),Infected,Recovered,Dead,40, months=3)
