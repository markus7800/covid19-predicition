...
scatter!(l+1:length(Infected), Infected[l+1:length(Infected)], label="new Infected")
scatter!(l+1:length(Recovered), Recovered[l+1:length(Recovered)], label="new Recovered")
scatter!(l+1:length(Dead), Dead[l+1:length(Dead)], label="new Dead")
